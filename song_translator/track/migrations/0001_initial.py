    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('owner', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, related_name='singer_user', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Track',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('owner', models.ForeignKey(default=1, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='translation_user', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('owner', models.ForeignKey(default=1, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='comment_owner', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('old_value', models.TextField(blank=True, max_length=100, null=True)),
                ('new_value', models.TextField(blank=True, max_length=100, null=True)),
                ('author', models.ForeignKey(default=1, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='audit_owner', to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
